...
const api = {
  ...
  printerPrintReport: (data) => ipcRenderer.invoke('printer-print-report', data),          // IP cash report (Z-report)
  printerPrintUSBReport: (data) => ipcRenderer.invoke('printer-print-usb-report', data),    // USB cash report
  printerPrintWindowsUSBReport: (data) => ipcRenderer.invoke('printer-print-windows-usb-report', data), // Windows USB cash report
