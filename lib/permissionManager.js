...
class PermissionManager {
  ...
  canAccessCustomerAccount() {
    return this.hasPermission('CUSTOMER_ACCOUNT')
  }

  canViewMyTill() {
    return this.hasPermission('MY_TILL')
  }
  ...
  canDeleteOrderItem() {
    return this.hasPermission('DELETE_ORDER_ITEM')
  }

  canViewSalesAnalytics() {
    return this.hasPermission('VIEW_SALES_ANALYTICS')
  }

  canAcceptPayment() {
    return this.hasPermission('ACCEPT_PAYMENT')
  }

  canPlaceComplimentaryOrder() {
    return this.hasPermission('COMPLIMENTARY_ORDER')
  }

  canSendAccountBill() {
    return this.hasPermission('SEND_ACCOUNT_BILL')
  }
...
export const usePermissions = () => ({
  ...
  canAccessCustomerAccount: () => permissionManager.canAccessCustomerAccount(),
  ...
  canDeleteOrderItem: () => permissionManager.canDeleteOrderItem(),
  canViewSalesAnalytics: () => permissionManager.canViewSalesAnalytics(),
  canSendAccountBill: () => permissionManager.canSendAccountBill(),
})
