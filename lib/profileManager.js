      ...
      if (existingUser) {
        try {
          ...
          const updatedUserData = {
            ...
            show_powered_by_airoxlab: profileData.show_powered_by_airoxlab,
            show_dispatch_button: profileData.show_dispatch_button,
            business_start_time: profileData.business_start_time,
            business_end_time: profileData.business_end_time,
            receipt_review_message: profileData.receipt_review_message,
            receipt_footer_message: profileData.receipt_footer_message,
          }
  ...
  async fetchProfileFromDatabase() {
    try {
      ...
      const { data, error } = await supabase
        .from('users')
        .select('id, customer_name, email, store_name, phone, phone_secondary, store_address, store_logo, qr_code, invoice_status, hashtag1, hashtag2, show_footer_section, show_logo_on_receipt, show_business_name_on_receipt, show_powered_by_airoxlab, show_dispatch_button, business_start_time, business_end_time, receipt_review_message, receipt_footer_message')
        .eq('email', userEmail)
        .single()
      ...
      const profileData = {
        ...
        show_footer_section: data.show_footer_section === false ? false : true,
        show_logo_on_receipt: data.show_logo_on_receipt === false ? false : true,
        show_business_name_on_receipt: data.show_business_name_on_receipt === false ? false : true,
        show_powered_by_airoxlab: data.show_powered_by_airoxlab === false ? false : true,
        show_dispatch_button: data.show_dispatch_button === false ? false : true,
  ...
  async updateProfileInDatabase(profileData) {
    try {
      ...
      const updateData = {
        ...
        phone_secondary: profileData.phone_secondary !== undefined ? (profileData.phone_secondary || null) : undefined,
        ...
        show_footer_section: profileData.show_footer_section === false ? false : true,
        show_logo_on_receipt: profileData.show_logo_on_receipt === false ? false : true,
        show_business_name_on_receipt: profileData.show_business_name_on_receipt === false ? false : true,
        show_powered_by_airoxlab: profileData.show_powered_by_airoxlab === false ? false : true,
        show_dispatch_button: profileData.show_dispatch_button === false ? false : true,
        business_start_time: profileData.business_start_time || '10:00',
        business_end_time: profileData.business_end_time || '03:00',
        receipt_review_message: profileData.receipt_review_message !== undefined ? (profileData.receipt_review_message || null) : undefined,
        receipt_footer_message: profileData.receipt_footer_message !== undefined ? (profileData.receipt_footer_message || null) : undefined,
  ...
  async updateProfile(profileData, newLogoFile = null, newQrFile = null) {
    try {
      ...
      const finalProfile = {
        ...
        phone_secondary: databaseResult.phone_secondary || '',
        store_address: databaseResult.store_address,
        store_logo: databaseResult.store_logo,
        qr_code: databaseResult.qr_code,
        ...
        show_powered_by_airoxlab: databaseResult.show_powered_by_airoxlab === false ? false : true,
        show_dispatch_button: databaseResult.show_dispatch_button === false ? false : true,
        business_start_time: databaseResult.business_start_time || '10:00',
        business_end_time: databaseResult.business_end_time || '03:00',
        receipt_review_message: databaseResult.receipt_review_message || '',
        receipt_footer_message: databaseResult.receipt_footer_message || '',
      }
